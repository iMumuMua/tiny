...
(function () {
  ...
  Controller.prototype._createCell = function (args) {
   ...
   */
   Controller.prototype._runTask = function (task, callback) {
    var self = this;
  ...
  Controller.prototype._runFlowTask = function (index) {
    var self = this;
  ...
  Controller.prototype._runFlowTasks = function () {
    this._runFlowTask(0);
  };
  ...
  /**
   * use 'finish' instead of 'run' in sub tiny-control
   * @param {Function} finishCallback looks like function (callback) {}, use callback() to finish
   */
  Controller.prototype.finish = function (finishCallback) {
    var self = this;
    self._finishCallback = finishCallback;
  };

  Controller.prototype.run = function (runCallback) {
    var self = this;
    if (runCallback || self._finishCallback) {
      self._runCallback = function () {
        try {
          if (self._finishCallback) {
            self._finishCallback(function (err) {
              if (err) {
                self._errorHandler(err);
                return;
              }
  ...
  Controller.prototype.destroy = function () {
    this._kind = null;
    this._flowTasks = null;
    this._parallelTasks = null;
    this._whileConditionFunc = null;
    this._doTask = null;
    this._isDefaultErrorHandler = null;
