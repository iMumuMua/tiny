...
(function() {
  ...
  tiny.go = function() {
    ...
    return ctrl.go.apply(ctrl, arguments);
  };

  tiny.parallel = function() {
    var ctrl = new tiny.Controller();
    return ctrl.parallel.apply(ctrl, arguments);
  };

  tiny.while = function(cond) {
    var ctrl = new tiny.Controller();
    return ctrl.while(cond);
  };

  tiny.do = function() {
    var ctrl = new tiny.Controller();
    return ctrl.do.apply(ctrl, arguments);
  };

  tiny.each = function(arr) {
    var ctrl = new tiny.Controller();
    return ctrl.each(arr);
  };

  tiny.map = function(arr) {
    var ctrl = new tiny.Controller();
    return ctrl.map(arr);
  };
